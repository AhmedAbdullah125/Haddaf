        ...
        <div className="flex flex-col flex-small-col gap-small main-content mb-9">
            {
                tabs.map((tab) => (
                    <motion.div
                        ...
                        key={tab.id} className="home-tab flex md-gap-6-gap-2 items-center relative md:h-28 h-20 w-full overflow-auto cursor-pointer rounded-3xl border border-gray-200 bg-white variable-p-small shadow-[0_4px_10px_0_rgba(46,173,0,0.25)]" onClick={() => setActiveTab(tab.id)}>
