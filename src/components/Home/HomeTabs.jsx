...
const HomeTabs= ({ activeTab, setActiveTab }) => {
    ...
    return (
        <div className="flex gap-10 main-content mb-9">
            {/* KPI cards */}
            {/* عدد الملاعب */}
            <div className="flex gap-6 items-center relative h-28 w-full overflow-auto cursor-pointer rounded-3xl border border-gray-200 bg-white p-6 shadow-[0_4px_10px_0_rgba(46,173,0,0.25)]"
