                ...
                <tr key={row.id} className="border-t border-gray-100">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-4">
                      <button className="text-gray-600 hover:text-gray-700" aria-label="view"><IconEye /></button>
                      <button className="text-green-600 hover:text-green-700" aria-label="edit"><IconEdit /></button>
