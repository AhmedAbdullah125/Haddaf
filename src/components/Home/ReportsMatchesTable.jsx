            ...
            <tbody>
              {data.rows.map((row) => (
                <tr key={row.id} className="border-t border-gray-100">
                  ...
                  <td className="px-6 py-3 text-777 text-nowrap text-lg font-medium">{row.players}</td>
                  <td className="px-6 py-3 text-777 text-nowrap text-lg font-medium">{row.duration}</td>
                  <td className="px-6 py-3 text-777 text-nowrap text-lg font-medium">{row.date}</td>
                  <td className="px-6 py-3 text-777 text-nowrap text-lg font-medium">{row.time}</td>
                  <td className="px-6 py-3 text-777 text-nowrap text-lg font-medium">{row.remaining}</td>
                  <td className="px-6 py-3 text-777 text-nowrap text-lg font-medium">{row.slotCost}</td>
